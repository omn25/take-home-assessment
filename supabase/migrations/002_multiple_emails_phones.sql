...
CREATE POLICY "Allow all operations for authenticated users" ON contact_emails
  FOR ALL USING (true) WITH CHECK (true);

CREATE POLICY "Allow all operations for authenticated users" ON contact_phones
  FOR ALL USING (true) WITH CHECK (true);
